    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    for (int i = 1; i < userName.Length; i++)
                    {
                        ...
                        //    break;
                        //}
                        int asci2 = (int)userName[i];
                        if (asci2 <= 65 || asci2 >= 122)
                        {
                            k = false;
                            break;

                        }
                        else if (asci <= 91 || asci >= 96)
                        {
                            k = true;
            ...
            while (true)
            {
                ...
                int asci3 = (int)userSurname[0];
                if (asci3 < 65 || asci3 > 90)
                {
                    Console.WriteLine("ilk herf boyuk olmalidir");
                    continue;
                ...
                else
                {
                    ...
                    for (int i = 1; i < userSurname.Length; i++)
                    {
                        ...
                        //    break;
                        //}
                        int asci4 = (int)userSurname[i];
                        if (asci4 <= 65 || asci4 >= 122)
                        {
                            k = false;
                            break;

                        }
                        else if (asci4 <= 91 || asci4 >= 96)
                        {
                            k = true;
            ...
            while (true)
            {
                ...
                int asci5 = (int)fatherName[0];
                if (asci5 < 65 || asci5 > 90)
                {
                    Console.WriteLine("ilk herf boyuk olmalidir");
                    continue;
                ...
                else
                {
                    ...
                    for (int i = 1; i < fatherName.Length; i++)
                    {
                        ...
                        int asci6 = (int)fatherName[i];
                        if (asci6 <= 65 || asci6 >= 122)
                        {
                            k = false;
                            break;

                        }
                        else if (asci6 <= 91 || asci6 >= 96)
                        {
                            k = true;
